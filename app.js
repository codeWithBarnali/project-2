...
function showWeatherReport(weather){
    ...
    if(id<211 && id>200)
        ...
        {
        image.src="images/moderate-rain.svg"
        }
        else if(id<503 && id>500)
        {
        image.src="images/light-rain.svg"
        }
        else if(id<600 && id>503)
        {
        image.src="images/shower-rain.svg"
        }

        else if(id<603 && id>599)
        {
        image.src="images/light-snow.svg"
        }
        ...
        {
        image.src="images/heavy-snow.svg"
        } 
        ...
        {
        image.src="images/few-cloud.svg"
        } 
        else if(id==802)
        {
        image.src="images/scattred-clouds.svg"
        } 
        else if(id==803)
        {
        image.src="images/broken-clouds.svg"
        } 
        else if(id==804)
        {
        image.src="images/overcust.svg"
        } 
